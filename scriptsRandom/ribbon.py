...
def ribbon (_objA, _objB, _divisions, _name):
	...
	mc.orientConstraint(aimFix,grpCTRL[1], mo=1)
	...
	oriShort=mc.orientConstraint(drvJoints[0], drvJoints[2], drvJoints[1], mo=1)
	print oriShort
...
ribbon(sel[0], sel[1], 4, sel[0].replace('JNT', 'NURBS'))
